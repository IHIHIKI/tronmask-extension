...
const oldTestRpc = 'https://rawtestrpc.tronmask.io/'
const newTestRpc = 'https://testrpc.tronmask.io/'
  ...
  it('should convert providers', function () {
    ...
    return migration2.migrate(wallet1)
      .then((secondResult) => {
        ...
        assert.equal(secondData.config.provider.rpcTarget, 'https://rpc.tronmask.io/', 'main provider should be our rpc')
