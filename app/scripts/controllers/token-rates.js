...
export default class TokenRatesController {
  ...
  async updateExchangeRates () {
    ...
    const nativeCurrency = this.currency ? this.currency.state.nativeCurrency.toLowerCase() : 'trx'
    ...
    if (this._tokens.length > 0) {
      try {
        ...
        log.warn(`TronMask - TokenRatesController exchange rate fetch failed.`, error)
      }
    }
