...
export default class PreferencesController {
   ...
   *  {@link https://github.com/tron/EIPs/blob/master/EIPS/eip-20.md#symbol}
   * @property {boolean} decimals - The number of decimals the token uses.
   *  {@link https://github.com/tron/EIPs/blob/master/EIPS/eip-20.md#decimals}
   */
   ...
   *
   */
  addToFrequentRpcList (url, chainId, ticker = 'TRX', nickname = '', rpcPrefs = {}) {
    const rpcList = this.getFrequentRpcListDetail()
    const index = rpcList.findIndex((element) => {
