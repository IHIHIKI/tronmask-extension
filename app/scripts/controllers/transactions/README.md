...
exposed to the TronMask controller.
...
txMeta = {
  ...
  "status": "confirmed",
  "tronmaskNetworkId": "1524091532133", //the network id for the transaction
  ...
  "history": [
    { // debug information
      ...
      "time": 1524094064821,
      "status": "unapproved",
      "tronmaskNetworkId": "1524091532133",
