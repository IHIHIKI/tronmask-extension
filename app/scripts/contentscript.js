...
// TronMask will be much faster loading and performant on Firefox.
...
function injectScript (content) {
  try {
    ...
    console.error('TronMask provider injection failed.', e)
  }
}
...
async function setupStreams () {
  ...
  pump(
    ...
    pageStream,
    pageMux,
    (err) => logStreamDisconnectWarning('TronMask Inpage Multiplex', err),
  )
  pump(
    extensionMux,
    extensionStream,
    extensionMux,
    (err) => logStreamDisconnectWarning('TronMask Background Multiplex', err),
  )
...
function forwardTrafficBetweenMuxers (channelName, muxA, muxB) {
  ...
  pump(
    ...
    channelB,
    channelA,
    (err) => logStreamDisconnectWarning(`TronMask muxed traffic for channel "${channelName}" failed.`, err),
  )
}
...
function redirectToPhishingWarning () {
  console.log('TronMask - routing to Phishing Warning component')
