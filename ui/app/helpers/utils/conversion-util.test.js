...
describe('conversion utils', function () {
  ...
  describe('conversionUtil', function () {
    it('Returns expected types', function () {
      ...
      const conv2 = conversionUtil(1, { fromNumericBase: 'dec', fromDenomination: 'ETH', toDenomination: 'SUN' })
    ...
    it('Converts SUN to ETH', function () {
      assert.equal(conversionUtil('0xde0b6b3a7640000', { fromNumericBase: 'hex', toNumericBase: 'dec', fromDenomination: 'SUN', toDenomination: 'ETH' }), 1)
      assert.equal(conversionUtil('0x14d1120d7b160000', { fromNumericBase: 'hex', toNumericBase: 'dec', fromDenomination: 'SUN', toDenomination: 'ETH' }), 1.5)
    })
    it('Converts ETH to SUN', function () {
      assert.equal(conversionUtil('1', { fromNumericBase: 'dec', fromDenomination: 'ETH', toDenomination: 'SUN' }), 1000000000000000000)
      assert.equal(conversionUtil('1.5', { fromNumericBase: 'dec', fromDenomination: 'ETH', toDenomination: 'SUN' }), 1500000000000000000)
    })
    it('Converts ETH to GSUN', function () {
      assert.equal(conversionUtil('1', { fromNumericBase: 'dec', fromDenomination: 'ETH', toDenomination: 'GSUN' }), 1000000000)
      assert.equal(conversionUtil('1.5', { fromNumericBase: 'dec', fromDenomination: 'ETH', toDenomination: 'GSUN' }), 1500000000)
    })
