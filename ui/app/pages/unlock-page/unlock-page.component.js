...
export default class UnlockPage extends Component {
  ...
  static propTypes = {
    ...
    forceUpdateTronmaskState: PropTypes.func,
  ...
  handleSubmit = async (event) => {
    ...
    const { onSubmit, forceUpdateTronmaskState, showOptInModal } = this.props
    ...
    try {
      ...
      const newState = await forceUpdateTronmaskState()
