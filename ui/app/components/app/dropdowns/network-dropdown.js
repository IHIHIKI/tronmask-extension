...
class NetworkDropdown extends Component {
  ...
  getNetworkName () {
    ...
    if (providerName === 'mainnet') {
      ...
      name = this.context.t('nile')
    } else if (providerName === 'shasta') {
      name = this.context.t('shasta')
    ...
    return (
      ...
      >
        ...
        >
          ...
          <NetworkDropdownIcon backgroundColor="#ff4a8d" isSelected={providerType === 'nile'} />
          <span
            className="network-name-item"
            style={{
              color: providerType === 'nile'
                ? '#ffffff'
                : '#9b9b9b',
            }}
          >
        ...
        <DropdownMenuItem
          key="shasta"
          closeMenu={() => this.props.hideNetworkDropdown()}
          onClick={() => this.handleClick('shasta')}
          style={dropdownMenuItemStyle}
        >
          {
            providerType === 'shasta'
          ...
          <NetworkDropdownIcon backgroundColor="#29B6AF" isSelected={providerType === 'shasta'} />
          <span
            className="network-name-item"
            style={{
              color: providerType === 'shasta'
                ? '#ffffff'
                : '#9b9b9b',
            }}
          >
            {this.context.t('shasta')}
          </span>
        </DropdownMenuItem>
        <DropdownMenuItem
          key="default"
